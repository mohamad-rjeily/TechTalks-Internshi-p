...
<aside id="sidebar"
  ...
  <div class="p-6">
    ...
    <nav class="space-y-2 text-sm font-medium">
      ...
      <a href="{{ route('requests.index') }}" class="sidebar-link {{ request()->routeIs('requests.*') ? 'sidebar-active' : '' }} flex items-center p-3 rounded-lg">
        <i data-lucide="inbox" class="mr-3 sidebar-icon"></i>
        <span class="sidebar-text">Requests</span>
      </a>
      <a href="{{ route('reports.index') }}" class="sidebar-link {{ request()->routeIs('reports.*') ? 'sidebar-active' : '' }} flex items-center p-3 rounded-lg">
