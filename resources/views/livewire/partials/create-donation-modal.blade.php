  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg rounded-3">
      ...
      <div class="modal-body p-4">
        {{-- Medicine (locked if coming from browse) --}}
        <div class="mb-3">
          <label class="form-label fw-semibold">Medicine</label>

          @php $locked = $createMedicineLocked ?? false; @endphp

          @if($locked)
              <input type="hidden" wire:model="createMedicineId">
              <input type="text" class="form-control" value="{{ optional($medicines->firstWhere('id', (int)$createMedicineId))->name }}" readonly>
              <div class="form-text text-success">Selected from Browse Medicines</div>
          @else
              <select class="form-select @error('createMedicineId') is-invalid @enderror"
                      wire:model="createMedicineId" required>
        ...
        <div class="mb-3">
          ...
          <input type="number" min="1"
                 class="form-control @error('createQuantity') is-invalid @enderror"
                 wire:model="createQuantity" required>
        ...
        <div class="mb-3">
          ...
          <input type="date"
                 class="form-control @error('createExpiry') is-invalid @enderror"
                 wire:model="createExpiry" required>
        ...
        <div class="mb-3">
          ...
          <textarea rows="3"
                    ...
                    wire:model="createNotes"></textarea>
      ...
      <div class="modal-footer bg-light border-0 rounded-bottom-3">
        <button type="button" class="btn btn-outline-secondary"
                wire:click="resetCreateForm; $set('showCreateModal', false)">
          Cancel
        </button>
        <button type="button" class="btn btn-success"
                wire:click="createDonation" wire:loading.attr="disabled">
